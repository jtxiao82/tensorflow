...
class MulAccOp : public OpKernel {
 public:
  explicit MulAccOp(OpKernelConstruction* context) : OpKernel(context) {}
  Logging* log;
...
REGISTER_KERNEL_BUILDER(Name("MulAcc").Device(DEVICE_CPU), MulAccOp);
